#!/usr/bin/env python3
# =============================================================================
#  main.py  —  CODM Telegram Checker Bot  v5.7
#  Engine: shamp.py (inlined adapter)
#  Access: referral-only. No free starter. 5 referrals = 1-day key.
# =============================================================================
...
try:
    ...
    try:
        ...
        raise ImportError(
            "Engine not found. Place shamp.py (or TOSHIPRIVATE.py) next to main.py."
        )
...
class ResultsManager(_engine.ResultsManager):
    def __init__(self, combo_file_path, user_id=None, create_dirs=True):
        ...
        if user_id is not None:
            ...
            self.base_dir = Path("Results") / str(user_id) / f"{stem}_{self.timestamp}"
...
def run_check(item, accounts, state,
    ...
    file_manager = _engine.AccountFileManager()
        ...
        for _ in range(3):
            ...
            try:
                ...
                result = _engine.processaccount(
                    ...
                    cm, dd, ls, rm, file_manager,
                    item.combo_file, False,
...
def main():
    ...
    console.print()
    console.print(Panel(
        Text("CODM Account Checker Bot  v5.7", style="bold bright_magenta") +
    ...
    console.print(Panel(
        ...
        f"[bright_cyan]⬡[/bright_cyan]  Engine:   [dim]shamp.py[/dim]\n"
